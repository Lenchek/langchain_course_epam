"""Generated parking data (same as stage_2)."""
STATIC_DOCS = [
...
Nearest landmarks: City Hall (200 m), Central Station (500 m).""", "source": "location"},
...
Security: 24/7 surveillance and patrol.""", "source": "general"},
...
Payment is due on arrival; we accept card and cash.""", "source": "booking"},
...
Space numbering: Level B1 (1–150), B2 (151–300), B3 (301–450).""", "source": "parking_details"},
    {"content": """Cancellation policy: Free cancellation up to 2 hours before the reserved start time.
Late cancellations may incur a fee. No-shows are charged one hour at the standard rate.""", "source": "policies"},
]
