"""Ingest static data into Activeloop and seed SQLite. Run once from stage_1 folder."""
import os
import sys
...
def main():
    ...
    print("Initializing SQLite (dynamic data)...")
    init_db()
    print("Building vector store (Activeloop)...")
    build_vector_store(overwrite=True)
    print("Done. You can run: python run_chatbot.py")
